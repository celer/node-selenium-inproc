...
install:
	...
	(cd ext/chrome && wget $(npm_package_chrome_driver_linux32) -O linux_ia32.zip && unzip linux_ia32.zip -d linux_ia32)
	(cd ext/chrome && wget $(npm_package_chrome_driver_linux64) -O linux_ia64.zip && unzip linux_ia64.zip -d linux_ia64)
	@mkdir -p ext/safari
